...
export function isOfficer(arg: any): arg is models.Officer {
	return (
		...
		typeof arg === "object" &&
		// staffCode?: number
		(typeof arg.staffCode === "undefined" ||
			typeof arg.staffCode === "number") &&
		true
	);
}
...
export function isStolenCase(arg: any): arg is models.StolenCase {
	return (
		...
		(typeof arg.licenseNumber === "undefined" ||
			typeof arg.licenseNumber === "number") &&
		// OwnerName?: string
		(typeof arg.OwnerName === "undefined" ||
			typeof arg.OwnerName === "string") &&
		// type?: string
